...
const Language = () => {
        ...
        const [thirdInputShow, setShowThirdInput] = useState(false)
                                                ...
                                                <form onSubmit={formik.handleSubmit}>
                                                        <div className="flex justify-between flex-wrap   mt-4 items-center ">
                                                                ...
                                                                <div className="  languageType mr-1">
                                                                        ...
                                                                        <BasicSelect value={proficiency1} onChange={(e) => setProfency1(e)} />
                                                                </div>
                                                        </div>
                                                        {secondInputShow &&
                                                                <div className="flex justify-between flex-wrap   mt-4 items-center ">
                                                                        ...
                                                                        <div className="  languageType mr-1">
                                                                                ...
                                                                                <BasicSelect value={proficiency2} onChange={(e) => setProfency2(e)} />
                                                                        </div>
                                                                </div>
                                                        }
                                                        {thirdInputShow &&
                                                                <div className="flex justify-between flex-wrap   mt-4 items-center ">
                                                                        ...
                                                                        <div className="  languageType mr-1">
                                                                                ...
                                                                                <BasicSelect value={proficiency3} onChange={(e) => setProfency3(e)} />
                                                                        </div>
                                                                </div>
                                                        }
